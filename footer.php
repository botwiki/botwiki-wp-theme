      ...
      <div class="row">
        <div class="col-12">
          <div class="share-prompt">
            ...
            <p>
              Or <a href="mailto:?subject=<?php echo $page_title; ?>&amp;body=Botwiki is a collection of useful, friendly, and artistic online bots, and resources for making them.:%20<?php echo urlencode(home_url(add_query_arg(array(), $wp->request))); ?>" target="_blank" title="Send an email">via email</a>.
            </p>
