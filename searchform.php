<form class="form mt-2 mt-md-0 mb-5 text-right pr-0 w-100" method="get" action="<?php echo home_url(); ?>" role="search">
  ...
  <div id="search-filters" class="mt-3 text-left<?php if ( is_front_page() ) { echo ' d-none'; } ?>">
    ...
    <div class="form-check form-check-inline d-xs-block">
      <input class="form-check-input" type="radio" id="search-filters-everything" name="search-filters-options[]" value="everything"<?php if ( in_array('everything', $_GET['search-filters-options'] ) || empty( $_GET['search-filters-options'] ) ){ echo ' checked'; } ?>>
