  ...
  <?php if (have_posts()): while (have_posts()) : the_post(); ?>
      <div class="container mt-5">
        ...
        <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
          ...
          <!-- post title -->
          <h1 class="text-center post-title mt-5">
            <span<?php
                ...
                <div class="row list social-embeds p-2">
                  ...
                  ?>
                    <div class="list-item col-sm-12 col-md-6">
                      ...
                      <?php } elseif (strpos($tweet_html, 'tumblr-post') !== false) {
          ...
          <?php }
            ...
            if ($post_type === 'single') { ?>
          <p class="post-tags mt-5 mb-5"><?php the_tags('', ' ', '<br>'); // Separated by commas with a line break at the end 
                                          ?></p>
        <?php }
