    ...
    <tr>
      ...
      <td>
        ...
        if ( empty( $profile_img_url )){
          $profile_img_url = get_avatar_url( $user->ID, array( 'size' => 360, 'scheme' => 'https' ) );
        }
    ...
    <script type="text/javascript">
      jQuery(document).ready(function($){
        ...
        $('#clear-profile-img').click(function(e) {
          e.preventDefault();
          $('#profile-img-url').val('');
          $('#profile-img-preview').attr('src', '<?php echo get_avatar_url( $author_id, array( 'size' => 360, 'scheme' => 'https' ) ); ?>');
        });
      });
    </script>
  <?php }
